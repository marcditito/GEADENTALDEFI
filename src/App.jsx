...
const LogoImg = ({ style }) => (
  <svg viewBox="0 0 200 200" style={style} xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="100" y="85" fontFamily="Arial" fontSize="28" fontWeight="900" textAnchor="middle" fill="#1a1a1a">GEA-</text>
    <text x="100" y="122" fontFamily="Arial" fontSize="28" fontWeight="900" textAnchor="middle" fill="#4aad52">DENTAL</text>
    <circle cx="132" cy="50" r="10" fill="#6b3fa0"/>
    <text x="132" y="55" fontFamily="Arial" fontSize="12" fontWeight="900" textAnchor="middle" fill="white">🦷</text>
  </svg>
);
...
const WatermarkBg = () => (
  <div style={{ position:"fixed", inset:0, zIndex:0, pointerEvents:"none", overflow:"hidden", display:"grid", gridTemplateColumns:"repeat(auto-fill,180px)", gridTemplateRows:"repeat(auto-fill,180px)", opacity:0.04 }}>
    {Array.from({length:60}).map((_,i) => (
      <div key={i} style={{ width:180, height:180, display:"flex", alignItems:"center", justifyContent:"center" }}>
        <LogoImg style={{ width:140, height:140 }} />
      </div>
    ))}
  </div>
);
        ...
        <header className="futuristic-header" style={{ color:"white", position:"sticky", top:0, zIndex:100 }}>
          ...
          <div style={{ maxWidth:1100, margin:"0 auto", padding:"10px 14px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:8, position:"relative" }}>
            <div style={{ display:"flex", alignItems:"center", gap:12 }}>
              <LogoImg style={{ width:50, height:50, borderRadius:8, background:"white", padding:2 }} />
              <div>
              ...
              {items.length===0 ? (
                ...
                <div style={{display:"flex",flexDirection:"column",gap:10}}>
                  <div style={{position:"relative"}}>
                    <svg style={{position:"absolute",inset:-4,width:"calc(100% + 8px)",height:"calc(100% + 8px)",pointerEvents:"none",overflow:"visible"}} viewBox="0 0 300 56">
                      <rect x="2" y="2" width="296" height="52" rx="14" ry="14" fill="none" stroke="#25D366" strokeWidth="2.5" strokeDasharray="600" style={{animation:"borderRun 2s linear infinite"}}/>
                    </svg>
                    <div className="ws-scan" />
                    <button onClick={generarWhatsApp} className="btn-press glow-pulse" style={{width:"100%",padding:18,position:"relative",background:"linear-gradient(90deg,#128c3a,#25D366,#1da851)",color:"white",border:"none",borderRadius:12,fontSize:17,fontWeight:800,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:10}}>
